...
*objective..			Z =e= sum(j, dummy(j))- v('EX_ac_e_f');
...
constraint_52..			x('ac_c[c]') =e= 4.7447207976847;

constraint_53..			x('actp_c[c]') =e= 16.1180956509583;

constraint_54..			x('accoa_c[c]') =e= 16.118095650958320;

constraint_55..			x('pi_c[c]') =e= 16.118095650958320;
...
FILE RESULTS4 /OptMDFPathway_output.txt/;
